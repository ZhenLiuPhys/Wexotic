...
Decay_Zp = Decay(name = 'Decay_Zp',
                 particle = P.Zp,
                 partial_widths = {(P.mu__minus__,P.mu__plus__):'((8*gn**2*MMU**2 + 4*gn**2*MZp**2)*cmath.sqrt(-4*MMU**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.ta__minus__,P.ta__plus__):'((8*gn**2*MTA**2 + 4*gn**2*MZp**2)*cmath.sqrt(-4*MTA**2*MZp**2 + MZp**4))/(48.*cmath.pi*abs(MZp)**3)',
                                   (P.vm,P.vm__tilde__):'(gn**2*MZp**4)/(24.*cmath.pi*abs(MZp)**3)',
                                   (P.vt,P.vt__tilde__):'(gn**2*MZp**4)/(24.*cmath.pi*abs(MZp)**3)'})
